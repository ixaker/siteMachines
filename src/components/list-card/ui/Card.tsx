    ...
    <Link href={`/machine?id=${item.id}`} scroll={false}>
      {item ? (
        ...
        >
              ...
              <>
                <div className="hidden sm:block">
                  {item.data.mainImage.length > 0 ? (
                    ...
                    <Skeleton
                      className="max-w-[350px] object-contain w-[100%] max-h-[233px] h-[233px] bg-[#f5f5f5] "
                      animation="wave"
                      variant="rectangular"
                    />
                  )}
          ...
          <div className="flex flex-col pt-3 md:pt-0 gap-3 md:gap-0 md:justify-around md:h-full relative z-[0] sm:z-[1] group-hover:z-[3] bg-white sm:h-[150px] max-h-[150px] px-4 pb-2 rounded-b-lg group-hover:rounded-b-none transition-all duration-500 ease">
