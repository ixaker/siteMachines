...
const ListCharacteristicsInCard: React.FC<ListCharacteristicsInCardProps> = ({ characteristics }) => {
  return (
    <div className="px-4 z-[0] mt-3 sm:mt-0 group-hover:z-[2] rounded-b-lg sm:absolute bg-[white] w-full top-0 group-hover:shadow-md transition-all duration-500 ease group-hover:top-[100%]">
